...
nibbl.controller('travelCtrl', ['$state', '$scope', 'NgMap', '$timeout','routeService', function($state, $scope, NgMap, $timeout,routeService){
    ...
    vm.origin = "NH-95, Ludhiana - Chandigarh State Hwy, Punjab 140413";
    vm.destination = "NH-21, Chandigarh, Kharar - Landran Rd, Sector 118, Sahibzada Ajit Singh Nagar, Punjab 160055";
